...
import { LayoutDashboard, FolderKanban, Users, Search, Bell, ChevronDown, LogOut, CheckCircle2 } from 'lucide-react';
import { useAuth } from '../contexts/AuthContext';
import PMDashboard from './pm/PMDashboard';
import EmployeePool from './pm/EmployeePool';
import Projects from './pm/Projects';
import SkillValidations from './pm/SkillValidations';
...
export default function PMPortal() {
  ...
  const menuItems = [
    ...
    { id: 'employee-pool', label: 'Employee Pool', icon: Users },
    { id: 'skill-validations', label: 'Skill Validations', icon: CheckCircle2 },
  ];
      ...
      <aside className="w-64 shrink-0 sticky top-0 h-screen bg-white border-r-2 border-gray-200 overflow-y-auto overflow-x-hidden shadow-sm">
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-8 border-b-2 border-gray-200 shrink-0 bg-[#1e3a5f]">
            ...
            <p className="text-xs text-gray-200 mt-2 font-medium">Project Manager Portal</p>
          </div>
